...
#define DRAWFILLEDRECTANGLE CONCAT2(drawfilledrectangle,POSTFIX)
#define _DRAWFILLEDRECTANGLE CONCAT2(_,DRAWFILLEDRECTANGLE)
#define _DRAWFILLEDRECTANGLE_CB CONCAT2(_DRAWFILLEDRECTANGLE,_cb)

#define DRAWRECTANGLE CONCAT2(drawrectangle,POSTFIX)
#define _DRAWRECTANGLE CONCAT2(_,DRAWRECTANGLE)
#define _DRAWRECTANGLE_CB CONCAT2(_DRAWRECTANGLE,_cb)
